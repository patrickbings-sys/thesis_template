...
\usepackage[
    pdftitle={TITEL EINFÜGEN}, % Setzt den Titel des PDFs
    pdfsubject={},   % Setzt das Thema des PDFs (hier leer gelassen)
    pdfauthor={Nick Fischer}, % Setzt den Autor des PDFs
    pdfkeywords={},  % Setzt die Schlüsselwörter des PDFs (hier leer gelassen)
...
% TODO: Prüfen, ob das hier nicht besser Kapitel statt Abschn. heißen sollte
