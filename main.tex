...
\usepackage[
    pdftitle={Analyse von Variabilität in EEG-Daten im Ruhezustand und bei Bewegungsintentionen}, % Setzt den Titel des PDFs
    pdfsubject={Masterarbeit},   % Setzt das Thema des PDFs (hier leer gelassen)
    pdfauthor={Patrick Bings}, % Setzt den Autor des PDFs
    pdfkeywords={EEG, Variabilität, Bewegungsintention, Maschinelles Lernen},  % Setzt die Schlüsselwörter des PDFs (hier leer gelassen)
...
\begin{document}
	...
	\include{chapters/00_Titel} % Einbindung der Titelseite
	...
	\include{chapters/01_Eides_Statt} % Einbindung der Versicherugn an Eides Statt

	\include{chapters/02_Zusammenfassung} % Einbindung der Zusammenfassung
	...
	\include{chapters/03_Abkürzungsverzeichnis} % Einbinden des Abkürzungsverzeichnisses

	% \mainmatter
	\cleardoubleoddpage
	\pagenumbering{arabic}

	\include{chapters/02_Zusammenfassung}
	
	\include{chapters/04_Einleitung} % Einbindung der Einleitung

	\include{chapters/05_Theoretische_Grundlagen} % Einbindung der Theoretischen Grundlagen

	\include{chapters/06_Methoden} % Einbindung der Methoden

	\include{chapters/07_Ergebnisse} % Einbindung der Ergebnisse

	\include{chapters/08_Diskussion} % Einbindung der Diskussion

	\include{chapters/09_Fazit} % Einbindung der Fazit
	
	\include{chapters/10_Anhang} % Einbindung der Anhang
